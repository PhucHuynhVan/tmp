...
namespace BiasysControl.Features.Logins
{
    public partial class LoginForm : Form
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            _mainForm.isProcessedData = this.doLogin(this.txtUserID.Text.Trim(), this.txtPassword.Text.Trim());
            ...
            this.Close();
            _mainForm.DisplayActiveOrderNumberForm();//DisplayActiveAutomatForm();
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            //{
            //    TextBox activeTextBox = (TextBox)lastFocusedTextBox;
            //    currentText = activeTextBox.Text;
            //    var currentButton = (Button)sender;
            //    if (currentButton != null)
            //    {
            //        if(currentButton.Name != this.btnDel.Name)
            //        {
            //            currentText += currentButton.Text;
            //            activeTextBox.Text = currentText;
            //        }
            //        else
            //        {
            //            if (activeTextBox.Text.Trim().Length > 0)
            //            {
            //                var delText = activeTextBox.Text.Trim().Substring(0, activeTextBox.Text.Trim().Length - 1);
            //                activeTextBox.Text = delText;
            //            }
            //        }                    
            //    }
            //}
