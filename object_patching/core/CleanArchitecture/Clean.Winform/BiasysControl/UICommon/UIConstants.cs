namespace BiasysControl.UICommon
{
    ...
    {
        //Application name
        public const string APP_2_Name = "App2";
        ...
        public const string PANEL_RIGHT_CONTENT_NAME = "pnlRightContent";

        //user control name
        public const string UC_INITIAL_APP_NAME = "ucAppInformation";
    ...
    public static class UIFormNameConstants
    {
        ...
        public const string AUTOMATSELECT = "AutomatSelect";
        public const string BOBBINNUMBERINPUT = "BobbinNumberInput";
        public const string ORDERNUMBERINPUT = "OrderNumberInput";
    }
