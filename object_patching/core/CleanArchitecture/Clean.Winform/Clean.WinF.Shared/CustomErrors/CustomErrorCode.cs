namespace Clean.WinF.Shared.Constants
{
    public static class CustomErrorCode
    {
        ...
        //ARTICLE 
        public const string APP_ARTICLE_NAME_EMPTY = "APP_ARTICLE_NAME_EMPTY";
        public const string APP_ARTICLE_CODE_EMPTY = "APP_ARTICLE_CODE_EMPTY";
        public const string APP_ARTICLE_NOT_FOUND = "APP_ARTICLE_NOT_FOUND";
        public const string APP_ARTICLE_UPDATED_FAIL = "APP_ARTICLE_UPDATED_FAIL";
        public const string APP_ARTICLE_INVALID_NAME = "APP_ARTICLE_INVALID_NAME";
        public const string APP_ARTICLE_INVALID_CODE = "APP_ARTICLE_INVALID_CODE";
        //public const string BP_INVALID_PERMISSION_GROUP_STATUS = "BP_INVALID_PERMISSION_GROUP_STATUS";
        //public const string BP_PERMISSION_GROUP_EXISTED_ALREADY = "BP_PERMISSION_GROUP_EXISTED_ALREADY";
        //public const string BP_PERMISSION_GROUP_INVALID_NAME = "BP_PERMISSION_GROUP_INVALID_NAME";
        //public const string BP_PERMISSION_GROUP_REMOVED_FAIL = "BP_PERMISSION_GROUP_REMOVED_FAIL";
        ...
        //SUPPLIER
        public const string APP_SUPPLIER_NAME_EMPTY = "APP_SUPPLIER_NAME_EMPTY";
        public const string APP_SUPPLIER_CODE_EMPTY = "APP_SUPPLIER_CODE_EMPTY";
        public const string APP_SUPPLIER_NOT_FOUND = "APP_SUPPLIER_NOT_FOUND";
        public const string APP_SUPPLIER_UPDATED_FAIL = "APP_SUPPLIER_UPDATED_FAIL";
        public const string APP_SUPPLIER_INVALID_NAME = "APP_SUPPLIER_INVALID_NAME";
        public const string APP_SUPPLIER_INVALID_CODE = "APP_SUPPLIER_INVALID_CODE";
    }
    ...
    public static class CustomOperationCodes
    {
        ...
        //ARTICLE
        public const string APP_ARTICLE_ADD_SUCCESS = "APP_ARTICLE_ADD_SUCCESS";
        public const string APP_ARTICLE_ADD_FAIL = "APP_ARTICLE_ADD_FAIL";

        public const string APP_ARTICLE_UPDATE_SUCCESS = "APP_ARTICLE_UPDATE_SUCCESS";
        public const string APP_ARTICLE_UPDATE_FAIL = "APP_ARTICLE_UPDATE_FAIL";

        public const string APP_ARTICLE_DELETE_SUCCESS = "APP_ARTICLE_DELETE_SUCCESS";
        public const string APP_ARTICLE_DELETE_FAIL = "APP_ARTICLE_DELETE_FAIL";

        //SUPPLIER
        public const string APP_SUPPLIER_ADD_SUCCESS = "APP_SUPPLIER_ADD_SUCCESS";
        public const string APP_SUPPLIER_ADD_FAIL = "APP_SUPPLIER_ADD_FAIL";

        public const string APP_SUPPLIER_UPDATE_SUCCESS = "APP_SUPPLIER_UPDATE_SUCCESS";
        public const string APP_SUPPLIER_UPDATE_FAIL = "APP_SUPPLIER_UPDATE_FAIL";

        public const string APP_SUPPLIER_DELETE_SUCCESS = "APP_SUPPLIER_DELETE_SUCCESS";
        public const string APP_SUPPLIER_DELETE_FAIL = "APP_SUPPLIER_DELETE_FAIL";
    }
}
